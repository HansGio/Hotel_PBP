...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback, PermissionsListener {
    ...
    public void onMapReady(@NonNull MapboxMap mapboxMap) {
        ...
        mapboxMap.setStyle(new Style.Builder().fromUri(Style.MAPBOX_STREETS), new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                Point destinationPoint = Point.fromLngLat(110.416087,-7.779441);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && requestCode == REQUEST_CODE_AUTOCOMPLETE) {
            CarmenFeature selectedCarmenFeatures = PlaceAutocomplete.getPlace(data);
                ...
                if (style != null) {
                    ...
                    if(source != null) {
                        source.setGeoJson(FeatureCollection.fromFeatures(
                                new Feature[] {Feature.fromJson(selectedCarmenFeatures.toJson())}
                        ));
                    }

                    mapboxMap.animateCamera(CameraUpdateFactory.newCameraPosition(
                            new CameraPosition.Builder()
                                    .target(new LatLng(((Point) selectedCarmenFeatures.geometry()).latitude(),
                                            ((Point) selectedCarmenFeatures.geometry()).longitude()))
                                    .zoom(14)
                                    .build()), 4000);
                }
            }
